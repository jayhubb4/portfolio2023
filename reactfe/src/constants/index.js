import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        "Developed and maintained responsive web applications using React.js and other related technologies.",
    ...
    },
    {
      ...
      points: [
        "Building, maintaining, and deploying web applications for events in Javascript and PHP, with SCSS for styling.",
        "Collaborating with cross-functional teams including designers, product managers, and other developers to create high-quality products.",
        "Manage assets and DNS routing with AWS. ",
        "Participating in code reviews and providing constructive feedback to other developers.",
        "Building complex web-based UI for operators with varying permissions based on user profile.",
      ],
    },
  ];
